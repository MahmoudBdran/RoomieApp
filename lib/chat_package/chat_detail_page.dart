...
class _ChatDetailPageState extends State<ChatDetailPage> {
          ...
          children: <Widget>[
            ...
            Column(
              ...
              children: <Widget>[
                ...
                Text(
                  "Active now",
                  style: TextStyle(color: Colors.grey[200].withOpacity(0.6), fontSize: 14),
                )
              ],
            )
          ],
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: <Widget>[
            Icon(Icons.face,color: Colors.grey,size: 35,)
            ,SizedBox(width: 15,),
            Row(
            children: <Widget>[
              Container(
              ...
              SizedBox(width: 15,),
              Icon(EvaIcons.attachOutline,size:30,color: Colors.grey,),

              SizedBox(width: 15,),
              Icon(Icons.keyboard_voice_outlined,size:30,color: Colors.grey,),
            ],
            ),
  ...
  Widget getBody() {
    ...
    return Stack(
      children: [
        Image.asset("images/chat_background.jpg",height: MediaQuery.of(context).size.height,fit: BoxFit.cover,width: MediaQuery.of(context).size.width,),
        ListView(
