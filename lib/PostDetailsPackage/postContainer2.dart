...
class PostTemplate2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget _buildImageCarouselWD(List<String>images){
      print(images.length);
...
class _PostTemplateState extends State<PostTemplate> {
  ...
  Widget _buildImageCarouselWD(){
    return GestureDetector(
      ...
      child: Padding(
        padding: const EdgeInsets.fromLTRB(0, 5, 0, 0),
        //child: Image_Carousel(postData[index]['images']),
        child: ImagesContainerTemplate(imageList: postsList[index].images,),
      ),
    );
  }
  ...
  //
  //     });
  //     // print("this is print from post "+postsList[0].pets);
  //   });
  // }
